...
Funcionalidade: POST partner
  ...
  Cenário: Criar um parceiro com email já existente
    Dado que eu queira adicionar um novo parceiro
    Quando eu chamar o endpoint de criação de parceiro passando o email "exemplo@gmail.com" e o usuario "Tomaz Gouveia"
    Então eu devo receber o status "BadRequest" e a mensagem "Já existe um parceiro com o email informado"

    @regressivo
  Cenário: Criar um parceiro com email invalido
    Dado que eu queira adicionar um novo parceiro
    Quando eu chamar o endpoint de criação de parceiro passando o email "TESTEGMAIL.COM" e o usuario "TESTE"
    Então eu devo receber o status "BadRequest" e a mensagem "Email invalido"